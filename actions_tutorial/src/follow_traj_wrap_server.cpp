...
void feedbackCb(const control_msgs::FollowJointTrajectoryFeedbackConstPtr& feedback)
{
  ...
  if(cancelgoalactivated){
    for(int i=0;i<3;i++){
        ...
        {
            ROS_ERROR("Goal Cancelled:  z position %f is out of limits (%f,%f)",transformStamped.transform.translation.z, zmin,zmax);
            robotClient->cancelGoal();
        }
        break;
    }
...
bool moveRobotTrajectory(
        actions_tutorial::move_robot_trajectory::Request &req,
        actions_tutorial::move_robot_trajectory::Response &resp)
{
...
bool moveRobotTrajectorySafe(
        actions_tutorial::move_robot_trajectory_safe::Request &req,
        actions_tutorial::move_robot_trajectory_safe::Response &resp)
{
...
bool setPointToPointTrajectory(
        actions_tutorial::set_point_to_point_trajectory::Request &req,
        actions_tutorial::set_point_to_point_trajectory::Response &resp)
{
...
bool setGoalTolerances(
        actions_tutorial::set_goal_tolerances::Request &req,
        actions_tutorial::set_goal_tolerances::Response &resp){
...
int main(int argc, char **argv)
{
  ...
  robotClient = new Client("/pan_tilt/arm_joint_trajectory_controller/follow_joint_trajectory");
